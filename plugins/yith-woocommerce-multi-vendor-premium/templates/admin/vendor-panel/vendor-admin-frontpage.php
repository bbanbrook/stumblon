...
<div class="wrap yith-vendor-admin-wrap" id="vendor-details">
    <form method="post" action="<?php echo apply_filters( 'yith_wcmv_vendor_panel_form_action', admin_url( 'admin.php' ) ); ?>" enctype="multipart/form-data">
        ...
        <div class="form-field contact-info">
            ...
            <label for="vendor_vat"><?php echo apply_filters( 'yith_wcmv_tax_label_admin', __( 'VAT/SSN', 'yith-woocommerce-product-vendors' ) ) ?></label>
            ...
            <br />
            <?php $vat_ssn_string = apply_filters( 'yith_wcmv_tax_label_admin', __( 'VAT/SSN', 'yith-woocommerce-product-vendors' ) ); ?>
