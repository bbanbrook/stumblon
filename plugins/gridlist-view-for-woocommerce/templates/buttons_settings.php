...
<table class="form-table lgv_admin_settings buttons">
    ...
    <tr>
        <th><?php _e( 'Disable Font Awesome', 'BeRocket_LGV_domain' ) ?></th>
        <td>
            <label><input name="br_lgv_buttons_page_option[disable_fa]" type="checkbox" value="1"<?php if( ! empty($options['disable_fa']) ) echo ' checked'; ?>>
            <?php _e( 'use it only if you already has font awesome on your site', 'BeRocket_LGV_domain' ) ?></label>
        </td>
    </tr>
    <tr>
